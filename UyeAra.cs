...
namespace Kutuphanecsharp
{
    public partial class UyeAra : Form
    {
        ...
        {
            baglanti.Open();
            komut = new SQLiteCommand("Select ID,name,surname,phone,tc,birthdate,gender,education,address,okitaptoplam from Uyeler where name Like '%" + tbxSearch.Text + "%'", baglanti);
